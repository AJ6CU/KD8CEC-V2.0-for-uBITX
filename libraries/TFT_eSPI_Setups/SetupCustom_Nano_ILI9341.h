...
// For the Teensy use these #define lines
#define TFT_MISO  D12
#define TFT_MOSI  D11
#define TFT_SCLK  D13
#define TFT_CS    D10  // Chip select control pin
#define TFT_DC   	D9  // Data Command control pin
//#define TFT_RST  D15  // Reset pin (could connect to Arduino RESET pin)
//#define TFT_BL     // LED back-light

#define TOUCH_CS D8     // Chip select pin (T_CS) of touch screen
