...
// For the Arduino Mbed package the GPIO numbers must be used prefixed with p:
  ...
  #define TFT_MISO  D12 //D16 //D12
  #define TFT_MOSI  D11 //D19 //D11
  #define TFT_SCLK  D10 //D10
  #define TFT_CS    D13 //D13  // Chip select control pin
...
#define TFT_SPI_PORT 1 // Set to 0 if SPI0 pins are used, or 1 if spi1 pin/s used
